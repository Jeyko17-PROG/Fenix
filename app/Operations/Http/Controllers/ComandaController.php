...
use App\Shared\Infrastructure\Persistence\Eloquent\Auditoria;
use App\Operations\Infrastructure\Persistence\Eloquent\Cliente;
use App\Operations\Infrastructure\Persistence\Eloquent\Comanda;
use App\Operations\Infrastructure\Persistence\Eloquent\ComandaItem;
...
use App\Billing\Application\CreditService;
use App\Operations\Application\KardexService;
use App\Billing\Application\ReciboService;
    ...
    public function cobrar(Request $request, Comanda $comanda): JsonResponse
    {
        ...
        $factura = DB::transaction(function () use ($data, $request, $comanda, $clienteId) {
            ...
            $factura = Factura::create([
                ...
                'bodega_id' => \App\Business\Infrastructure\Persistence\Eloquent\Bodega::query()->orderByDesc('es_principal')->orderBy('id')->value('id'),
