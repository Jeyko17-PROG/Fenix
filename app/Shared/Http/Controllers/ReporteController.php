...
class ReporteController extends Controller
{
    ...
    private function datosCuenta(?\App\IAM\Infrastructure\Persistence\Eloquent\User $user): array
    {
        if (! $user) {
            return [];
        }
    ...
    {
        $minutosLaborales = \App\Operations\Infrastructure\Persistence\Eloquent\HorarioLaboral::where('dia_semana', (int) $dia->dayOfWeek)
            ->where('activo', true)
            ->get()
