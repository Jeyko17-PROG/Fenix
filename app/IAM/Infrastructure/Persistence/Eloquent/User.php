...
namespace App\IAM\Infrastructure\Persistence\Eloquent;
...
use App\IAM\Infrastructure\Notifications\RestablecerPasswordNotification;
...
class User extends Authenticatable
{
    ...
    /**
     * Laravel deduce la factory a partir de `App\Models\<Modelo>`; como el modelo
     * ya no vive ahí, se indica explícitamente.
     */
    ...
    {
        return $this->hasMany(\App\Billing\Infrastructure\Persistence\Eloquent\UserCredit::class, 'user_id');
    }
