...
class FacturaController extends Controller
{
     ...
     */
    public function facturarOrden(Request $request, \App\Operations\Infrastructure\Persistence\Eloquent\ServiceOrder $serviceOrder)
    {
        $this->bloquearMecanico($request);
     ...
     */
    private function cobrarUsoPorFactura(\App\IAM\Infrastructure\Persistence\Eloquent\User $user): void
    {
