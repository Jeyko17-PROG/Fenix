...
use App\Operations\Infrastructure\Persistence\Eloquent\ServiceOrderDetail;
use App\Operations\Infrastructure\Persistence\Eloquent\Producto;
use App\Business\Infrastructure\Persistence\Eloquent\OperablesEmployee;
use App\Operations\Infrastructure\Persistence\Eloquent\AssetHistory;
use App\Operations\Application\KardexService;
...
class ServiceOrderController extends Controller
{
    ...
    {
        return (float) (\App\Operations\Infrastructure\Persistence\Eloquent\StockBodega::where('producto_id', $productoId)
    ...
    public function buscarPorPlacaOOrden(Request $request): JsonResponse
    {
        ...
        $activos = \App\Operations\Infrastructure\Persistence\Eloquent\AssetVehicle::where('placa_identificador', 'like', "%{$query}%")
    ...
    private function esOperarioLimitado(?\App\IAM\Infrastructure\Persistence\Eloquent\User $user): bool
    {
