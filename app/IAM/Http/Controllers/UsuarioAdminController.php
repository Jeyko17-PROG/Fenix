...
use App\Billing\Infrastructure\Persistence\Eloquent\CreditPackage;
...
class UsuarioAdminController extends Controller
{
    ...
    public function crearEmpleado(Request $request): JsonResponse
    {
        ...
        if (! empty($data['operables_employee_id'])) {
            $empleadoTaller = \App\Business\Infrastructure\Persistence\Eloquent\OperablesEmployee::withoutGlobalScopes()->findOrFail($data['operables_employee_id']);
    ...
    public function cambiarPlan(Request $request, User $usuario): JsonResponse
    {
        ...
        app(\App\Shared\Application\Notificador::class)->aUsuario(
