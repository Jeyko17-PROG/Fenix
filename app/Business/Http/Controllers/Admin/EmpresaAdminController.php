...
namespace App\Business\Http\Controllers\Admin;

use App\Shared\Http\Controllers\Controller;
use App\Business\Http\Requests\ActualizarEmpresaRequest;
...
use App\IAM\Infrastructure\Persistence\Eloquent\Modulo;
...
class EmpresaAdminController extends Controller
{
    ...
    public function aplicarPlanModulos(Request $request, Empresa $empresa): JsonResponse
    {
        ...
        \App\IAM\Infrastructure\Persistence\Eloquent\UserFuncionalidad::where('user_id', $empresa->owner_user_id)->delete();
